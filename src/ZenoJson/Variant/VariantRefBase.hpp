...
#include <ZenoJson/Variant/Converter.hpp>
#include <ZenoJson/Variant/JsonVariantConst.hpp>
#include <ZenoJson/Variant/VariantOperators.hpp>
...
class VariantRefBase : public VariantTag {
 ...
 private:
  ...
  FORCE_INLINE ZenoJson::JsonVariant getVariant() const;

  FORCE_INLINE ZenoJson::JsonVariantConst getVariantConst() const {
    return ZenoJson::JsonVariantConst(getData(), getResourceManager());
  }
  ...
  ZenoJson::JsonVariant getOrCreateVariant() const;
};
