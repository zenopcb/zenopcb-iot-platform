...
#include <ZenoJson/Numbers/arithmeticCompare.hpp>
...
#include <ZenoJson/Variant/JsonVariantVisitor.hpp>
...
template <typename T>
struct Comparer<
    T, enable_if_t<is_convertible<T, ZenoJson::JsonVariantConst>::value>>
    : VariantComparer {
...
template <typename T>
CompareResult compare(ZenoJson::JsonVariantConst lhs, const T& rhs) {
