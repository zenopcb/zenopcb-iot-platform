...
#include <ZenoJson/Serialization/Writer.hpp>

ARDUINOJSON_BEGIN_PRIVATE_NAMESPACE

template <template <typename> class TSerializer, typename TWriter>
size_t doSerialize(ZenoJson::JsonVariantConst source, TWriter writer) {
...
size_t serialize(ZenoJson::JsonVariantConst source,
...
enable_if_t<!TSerializer<StaticStringWriter>::producesText, size_t> serialize(
    ZenoJson::JsonVariantConst source, void* buffer, size_t bufferSize) {
...
enable_if_t<IsChar<TChar>::value, size_t> serialize(
    ZenoJson::JsonVariantConst source, TChar (&buffer)[N]) {
