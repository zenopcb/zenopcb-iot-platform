...
#include <ZenoJson/Polyfills/assert.hpp>
...
#ifndef strlen_P
inline size_t strlen_P(ZenoJson::detail::pgm_p s) {
...
#ifndef strncmp_P
inline int strncmp_P(const char* a, ZenoJson::detail::pgm_p b, size_t n) {
  const char* s1 = a;
...
#ifndef strcmp_P
inline int strcmp_P(const char* a, ZenoJson::detail::pgm_p b) {
  const char* s1 = a;
  const char* s2 = b.address;
  ARDUINOJSON_ASSERT(s1 != NULL);
  ARDUINOJSON_ASSERT(s2 != NULL);
...
#ifndef memcmp_P
inline int memcmp_P(const void* a, ZenoJson::detail::pgm_p b, size_t n) {
...
#ifndef memcpy_P
inline void* memcpy_P(void* dst, ZenoJson::detail::pgm_p src, size_t n) {
...
inline uint32_t pgm_read_dword(ZenoJson::detail::pgm_p p) {
  uint32_t result;
...
inline float pgm_read_float(ZenoJson::detail::pgm_p p) {
  float result;
...
inline double pgm_read_double(ZenoJson::detail::pgm_p p) {
...
#ifndef pgm_read_ptr
inline void* pgm_read_ptr(ZenoJson::detail::pgm_p p) {
  void* result;
