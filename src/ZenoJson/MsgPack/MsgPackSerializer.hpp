...
#include <ZenoJson/MsgPack/endianness.hpp>
#include <ZenoJson/Polyfills/assert.hpp>
#include <ZenoJson/Polyfills/type_traits.hpp>
#include <ZenoJson/Serialization/CountingDecorator.hpp>
#include <ZenoJson/Serialization/measure.hpp>
#include <ZenoJson/Serialization/serialize.hpp>
...
inline size_t serializeMsgPack(JsonVariantConst source, TDestination& output) {
  using namespace ZenoJson::detail;
