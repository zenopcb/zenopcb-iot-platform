...
// and `static EEPROMClass EEPROM` to `static ZenoFlashStorage ZenoEEPROM`. SPDX MIT
// header preserved; LICENSE unchanged. Upstream is archived 2023-02 but binary-stable
// (see VENDORED.md "Note").
...
// ============================================================================
// ZenoPCB Plan 07-03 — TU guard at vendor surface (mirrors Phase 6 Plan 06-2.5d
...
#endif    //#ifndef FlashStorage_STM32_h
