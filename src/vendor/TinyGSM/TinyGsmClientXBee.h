  ...
  class GsmClientXBee : public GsmClient {
   ...
   public:
    ...
    void stop(uint32_t maxWaitMs) {
      ...
      // much more nicely with libraries like PubSubClient (vendored in this
      // project as ZenoPubSubClient per Plan 06-2.5c — minimal touch logged
      // in lib/ZenoPCB/src/vendor/TinyGSM/VENDORED.md).
    }
    void stop() override {
      stop(5000L);
    }
