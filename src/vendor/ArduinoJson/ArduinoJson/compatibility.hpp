...
#define ARDUINOJSON_NAMESPACE _Pragma ("GCC warning \"ARDUINOJSON_NAMESPACE is deprecated, use ArduinoJson instead\"") ZenoJson

// DEPRECATED: you don't need to compute the size anymore
#define JSON_ARRAY_SIZE(N) _Pragma ("GCC warning \"JSON_ARRAY_SIZE is deprecated, you don't need to compute the size anymore\"") (ZenoJson::detail::sizeofArray(N))

// DEPRECATED: you don't need to compute the size anymore
#define JSON_OBJECT_SIZE(N) _Pragma ("GCC warning \"JSON_OBJECT_SIZE is deprecated, you don't need to compute the size anymore\"") (ZenoJson::detail::sizeofObject(N))
...
// DEPRECATED: you don't need to compute the size anymore
#define JSON_ARRAY_SIZE(N) (ZenoJson::detail::sizeofArray(N))

// DEPRECATED: you don't need to compute the size anymore
#define JSON_OBJECT_SIZE(N) (ZenoJson::detail::sizeofObject(N))
