 ...
 *
 * Mechanical mirror of `Esp8266System.{h,cpp}` see
 * "Stm32System". STM32duino does NOT expose an `ESP.*`
 ...
 *
 * Per (NEW user 2026-06-03 #3) Arduino-minimal: the bodies
 ...
 *
 * deleted copy semantics (NVIC + IWatchdog are global
...
// / TU guard at header surface. STM32-specific
...
public:
    ...
    // Deleted copy semantics (NVIC + IWatchdog are globals).
