 ...
 *
 * Mechanical mirror of `Esp8266Storage.{h,cpp}` Pattern A — see Phase 7
 * 07-PATTERNS.md §"Stm32Storage" (STUB section). STM32duino's default
 ...
 * port — out of v1.0.0 scope per 07-CONTEXT D-12.
 *
