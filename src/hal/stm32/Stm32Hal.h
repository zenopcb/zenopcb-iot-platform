...
// Pattern B / Pitfall 7 lifted to .h surface (mirrors Plan 06-2.5d fix for
// Esp8266 family): the contained Stm32*.h sub-impls include STM32-only
// headers (`<IWatchdog.h>`, the vendored ZenoFlashStorage from Plan 07-03,
 ...
 * no eager file-scope global. Plan 07-05 wires this into the Zeno class
